...
export default function AdminDashboard() {
  ...
  const filteredTasks = tasks.filter((task) => {
    ...
    const matchesItemType =
      itemTypeFilter === "All" || (task.item_type || "Task") === itemTypeFilter;

    return matchesSearch && matchesStatus && matchesPriority && matchesItemType;
  });
                      ...
                      <tr key={task.id}>
                        ...
                        <td>
                          ...
                          >
                            ...
                            {task.item_type === "Feature" && "💡 "}
                            {task.item_type === "Story" && "📖 "}
                            {(task.item_type === "Task" || !task.item_type) && "📋 "}
                            {task.item_type || "Task"}
                          </span>
                        </td>
